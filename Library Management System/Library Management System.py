...
class Library:
    ...
    def __init__(self,root):
        ...
        self.lblTitle =Label(TitleFrame,width=39,font=('Times New Roman',40,'bold'),text="\tLibrary Management System\t",bg="yellow",fg='Crimson',padx=12)
        self.lblTitle.grid()
        ...
        DataFrameLEFT =LabelFrame(DataFrame,bd=10,width=900,height=300,padx=20,relief=RIDGE,font=('Times New Roman',12,'bold'),text="Library Membership Info:",fg="Crimson")
        ...
        self.btnDelete=Button(ButtonFrame,text="DELETE",fg="Crimson",bg="yellow",font=('Times New Roman',12,'bold'),width=30,bd=4,command=Delete)
        self.btnDelete.grid(row=0,column=1)

        self.btnReset=Button(ButtonFrame,text="RESET",fg="Crimson",bg="yellow",font=('Times New Roman',12,'bold'),width=30,bd=4,command=Reset)
        self.btnReset.grid(row=0,column=2)

        self.btnExit=Button(ButtonFrame,text="EXIT",fg="Crimson",bg="yellow",font=('Times New Roman',12,'bold'),width=30,bd=4,command=Exit)
